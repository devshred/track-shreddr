...
import org.devshred.tracks.tcx.TcxApp.XML_MAPPER
...
class TrainingCenterDatabaseTest {
    ...
    fun `testing a full TCX file`() {
        val tcx = TrainingCenterDatabase(
        ...
        val expected = this::class.java.classLoader.getResource("full.tcx").readText()
